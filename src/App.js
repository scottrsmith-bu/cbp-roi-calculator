          ...
          <div style={{display: 'flex', flexDirection: 'column', gap: '24px'}}>
            ...
            <div style={{background: 'white', borderRadius: '12px', padding: '32px', boxShadow: '0 4px 12px rgba(0,0,0,0.08)'}}>
              ...
              <div style={{display: 'flex', flexDirection: 'column', gap: '16px', fontSize: '14px', color: '#475569', lineHeight: '1.7'}}>
                ...
                <div>
                  ...
                  <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC9158739/" target="_blank" rel="noreferrer" style={{color: '#0066cc', marginLeft: '8px'}}>↗ View Study</a>
                </div>
                <div>
                  ...
                  <a href="https://curalinc.com/outcomes-study-2022" target="_blank" rel="noreferrer" style={{color: '#0066cc', marginLeft: '8px'}}>↗ View Study</a>
                </div>
                <div>
                  ...
                  <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4890098/" target="_blank" rel="noreferrer" style={{color: '#0066cc', marginLeft: '8px'}}>↗ View Study</a>
                </div>
                <div>
                ...
                <div>
                  ...
                  <a href="https://www.oig.dhs.gov/sites/default/files/assets/2021-05/OIG-21-34-May21.pdf" target="_blank" rel="noreferrer" style={{color: '#0066cc', marginLeft: '8px'}}>↗ View Report</a>
                </div>
                <div>
                ...
                <div>
                  ...
                  <a href="https://journals.aom.org/doi/abs/10.5465/amle.2022.0107" target="_blank" rel="noreferrer" style={{color: '#0066cc', marginLeft: '8px'}}>↗ View Study</a>
                </div>
              </div>
            </div>
            ...
            <div style={{background: 'white', borderRadius: '12px', padding: '32px', boxShadow: '0 4px 12px rgba(0,0,0,0.08)'}}>
              ...
              <div style={{fontSize: '15px', color: '#475569', lineHeight: '1.8'}}>
                ...
                • <a href="https://www.oig.dhs.gov/sites/default/files/assets/2021-05/OIG-21-34-May21.pdf" target="_blank" rel="noreferrer" style={{color: '#0066cc'}}>DHS OIG Reports</a>: Discipline case volumes and misconduct oversight<br/>
                ...
                • <a href="https://www.opm.gov/fevs/" target="_blank" rel="noreferrer" style={{color: '#0066cc'}}>Federal Employee Viewpoint Survey</a>: Climate and engagement data<br/>
                • <a href="https://www.dol.gov/agencies/owcp/FECA/programstatistics" target="_blank" rel="noreferrer" style={{color: '#0066cc'}}>FECA Program Data</a>: Workers' compensation claim costs and patterns<br/>
                <br/>
                ...
                • <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC9158739/" target="_blank" rel="noreferrer" style={{color: '#0066cc'}}>Montreal Police Service</a>: 22-year suicide prevention longitudinal study<br/>
                • <a href="https://curalinc.com/outcomes-study-2022" target="_blank" rel="noreferrer" style={{color: '#0066cc'}}>CuraLinc EAP (2022)</a>: Law enforcement EAP effectiveness research<br/>
                • <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4890098/" target="_blank" rel="noreferrer" style={{color: '#0066cc'}}>HeartMath Research</a>: HRV biofeedback for law enforcement stress<br/>
                • <a href="https://journals.aom.org/doi/abs/10.5465/amle.2022.0107" target="_blank" rel="noreferrer" style={{color: '#0066cc'}}>Meta-analysis of coaching effectiveness</a>: 37 RCTs, effect size 0.59<br/>
                <br/>
