          ...
          {/* Pyramid Cost Cascade Visualization */}
          <div style={{background: 'linear-gradient(135deg, #fef2f2 0%, #fee2e2 100%)', border: '4px solid #dc2626', borderRadius: '16px', padding: '32px'}}>
            <div style={{display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px'}}>
              <div style={{width: '48px', height: '48px', background: '#dc2626', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px'}}>⚠️</div>
              <h2 style={{fontSize: '24px', fontWeight: 'bold', color: '#991b1b', margin: 0}}>
                The Intervention Cost Cascade: Why Early Prevention Matters
              </h2>
            </div>
            
            <p style={{fontSize: '15px', color: '#7f1d1d', marginBottom: '24px', lineHeight: 1.6}}>
              Mental health intervention costs escalate dramatically when organizations wait until crisis. This pyramid shows the cost cascade from prevention (top) to crisis (bottom):
            </p>

            <div style={{display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '24px'}}>
              
              {/* Top - Prevention (Lowest Cost) */}
              <div style={{background: 'linear-gradient(135deg, #dcfce7 0%, #bbf7d0 100%)', border: '3px solid #16a34a', borderRadius: '12px', padding: '20px', width: '40%', margin: '0 auto'}}>
                <div style={{fontSize: '12px', color: '#15803d', fontWeight: 'bold', marginBottom: '8px', textAlign: 'center'}}>PREVENTION (Lowest Cost)</div>
                <div style={{fontSize: '16px', fontWeight: 'bold', color: '#15803d', textAlign: 'center', marginBottom: '8px'}}>
                  Coaching • Counseling
                </div>
                <div style={{fontSize: '13px', color: '#166534', textAlign: 'center', marginBottom: '4px'}}>
                  <strong>$0-$500/month</strong>
                </div>
                <div style={{fontSize: '11px', color: '#15803d', textAlign: 'center'}}>
                  EAP (FREE) • BetterUp ($150-$542/mo) • Coaching ($100-150/session)
                </div>
              </div>

              {/* Upper Middle - Early Treatment */}
              <div style={{background: 'linear-gradient(135deg, #fef3c7 0%, #fde68a 100%)', border: '3px solid #f59e0b', borderRadius: '12px', padding: '20px', width: '55%', margin: '0 auto'}}>
                <div style={{fontSize: '12px', color: '#92400e', fontWeight: 'bold', marginBottom: '8px', textAlign: 'center'}}>EARLY TREATMENT</div>
                <div style={{fontSize: '16px', fontWeight: 'bold', color: '#92400e', textAlign: 'center', marginBottom: '8px'}}>
                  Prescriptions • Outpatient Therapy
                </div>
                <div style={{fontSize: '13px', color: '#78350f', textAlign: 'center', marginBottom: '4px'}}>
                  <strong>$100-$250/session</strong>
                </div>
                <div style={{fontSize: '11px', color: '#92400e', textAlign: 'center'}}>
                  Medications ($5-25/mo) • Licensed therapist ($139-227/session) • 15-20 sessions typical
                </div>
              </div>

              {/* Middle - Intensive Treatment */}
              <div style={{background: 'linear-gradient(135deg, #fed7aa 0%, #fdba74 100%)', border: '3px solid #ea580c', borderRadius: '12px', padding: '20px', width: '70%', margin: '0 auto'}}>
                <div style={{fontSize: '12px', color: '#9a3412', fontWeight: 'bold', marginBottom: '8px', textAlign: 'center'}}>INTENSIVE TREATMENT</div>
                <div style={{fontSize: '16px', fontWeight: 'bold', color: '#9a3412', textAlign: 'center', marginBottom: '8px'}}>
                  Mental Health Professionals • Intensive Outpatient (IOP)
                </div>
                <div style={{fontSize: '13px', color: '#7c2d12', textAlign: 'center', marginBottom: '4px'}}>
                  <strong>$3,000-$10,000/month</strong>
                </div>
                <div style={{fontSize: '11px', color: '#9a3412', textAlign: 'center'}}>
                  IOP 9-15 hrs/week • Group therapy • Individual counseling • Med management
                </div>
              </div>

              {/* Lower - Crisis Treatment */}
              <div style={{background: 'linear-gradient(135deg, #fecaca 0%, #fca5a5 100%)', border: '3px solid #dc2626', borderRadius: '12px', padding: '20px', width: '85%', margin: '0 auto'}}>
                <div style={{fontSize: '12px', color: '#991b1b', fontWeight: 'bold', marginBottom: '8px', textAlign: 'center'}}>CRISIS INTERVENTION</div>
                <div style={{fontSize: '16px', fontWeight: 'bold', color: '#991b1b', textAlign: 'center', marginBottom: '8px'}}>
                  Partial Hospitalization • Inpatient Treatment
                </div>
                <div style={{fontSize: '13px', color: '#7f1d1d', textAlign: 'center', marginBottom: '4px'}}>
                  <strong>$15,000-$60,000/stay</strong>
                </div>
                <div style={{fontSize: '11px', color: '#991b1b', textAlign: 'center'}}>
                  PHP 6-8 hrs daily ($7-20K/mo) • Inpatient 24/7 care ($500-2K/day) • 7-14 day avg stays
                </div>
              </div>

              {/* Foundation - Worst Outcomes */}
              <div style={{background: 'linear-gradient(135deg, #7f1d1d 0%, #450a0a 100%)', border: '3px solid #450a0a', borderRadius: '12px', padding: '20px', width: '100%', margin: '0 auto'}}>
                <div style={{fontSize: '12px', color: '#fca5a5', fontWeight: 'bold', marginBottom: '8px', textAlign: 'center'}}>CATASTROPHIC OUTCOMES</div>
                <div style={{fontSize: '16px', fontWeight: 'bold', color: 'white', textAlign: 'center', marginBottom: '8px'}}>
                  Death Benefits • Permanent Disability • Suicide
                </div>
                <div style={{fontSize: '13px', color: '#fecaca', textAlign: 'center', marginBottom: '4px'}}>
                  <strong>$50,000-$2,000,000+</strong>
                </div>
                <div style={{fontSize: '11px', color: '#fca5a5', textAlign: 'center'}}>
                  FEGLI death benefits ($50-150K) • Economic impact ($1.5-2M) • Incalculable human cost
                </div>
              </div>

            </div>

            <div style={{background: 'white', borderRadius: '12px', padding: '20px', border: '2px solid #dc2626'}}>
              <h3 style={{fontSize: '18px', fontWeight: 'bold', color: '#991b1b', marginBottom: '12px', textAlign: 'center'}}>
                The Business Case for Early Intervention
              </h3>
              <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px'}}>
                <div style={{background: '#fee2e2', padding: '16px', borderRadius: '10px', border: '2px solid #fca5a5'}}>
                  <div style={{fontSize: '14px', fontWeight: 'bold', color: '#991b1b', marginBottom: '8px'}}>❌ Wait Until Crisis</div>
                  <div style={{fontSize: '13px', color: '#7f1d1d', lineHeight: 1.6}}>
                    Officer develops untreated PTSD → self-medicates with alcohol → performance declines → incident occurs → hospitalization ($15-60K) → potential separation ($150K) → or worst case suicide ($1.5-2M)
                  </div>
                  <div style={{fontSize: '15px', fontWeight: 'bold', color: '#dc2626', marginTop: '12px'}}>
                    Total Cost: $165K-$2M+
                  </div>
                </div>
                <div style={{background: '#dcfce7', padding: '16px', borderRadius: '10px', border: '2px solid #86efac'}}>
                  <div style={{fontSize: '14px', fontWeight: 'bold', color: '#15803d', marginBottom: '8px'}}>✓ Intervene Early</div>
                  <div style={{fontSize: '13px', color: '#166534', lineHeight: 1.6}}>
                    Officer shows early stress signs → BetterUp coaching engagement ($150-542/mo) → builds resilience skills → processes trauma healthily → stays mission-ready → retains through 2028
                  </div>
                  <div style={{fontSize: '15px', fontWeight: 'bold', color: '#16a34a', marginTop: '12px'}}>
                    Total Cost: $1,800-$6,500/year
                  </div>
                </div>
              </div>
              <div style={{background: '#fef3c7', borderRadius: '10px', padding: '16px', marginTop: '16px', border: '2px solid #fbbf24', textAlign: 'center'}}>
                <p style={{fontSize: '14px', color: '#78350f', margin: 0, fontWeight: '600'}}>
                  <strong>ROI Multiplier:</strong> Every $1 invested in coaching prevents $25-$300+ in crisis intervention costs. Plus: preserved institutional knowledge, maintained operational readiness, lives saved.
                </p>
              </div>
            </div>

            <div style={{background: '#fffbeb', borderRadius: '10px', padding: '16px', marginTop: '16px', border: '2px solid #fbbf24'}}>
              <p style={{fontSize: '13px', color: '#78350f', margin: 0, lineHeight: 1.6}}>
                <strong>CBP Context:</strong> The 14 suicides in 2022 cost an estimated $21-28M in economic impact alone. A Montreal-model prevention program with $2-3M initial investment and $1M annual cost could prevent 7-11 deaths annually (50-79% reduction), generating $10.5-22M in annual savings with payback period under one year.
              </p>
            </div>
          </div>
